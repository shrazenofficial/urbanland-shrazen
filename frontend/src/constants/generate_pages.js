...
function generateTemplate(pageName, config, parsed) {
  const imagesImports = config.images.map((img, idx) => {
    let resolvedPath = "";
    if (img === "benchesImg") resolvedPath = "products/Product Images/Benches/Create_a_clean,_premium,_professional_202605162312.jpeg";
    else if (img === "benchesUgc") resolvedPath = "products/Product Images/Benches/UGC_Benches.jpeg";
    else if (img === "benchHero") resolvedPath = "Bench.jpeg";
    else if (img === "cabanasImg") resolvedPath = "products/Product Images/Cabanas/Create_a_clean,_premium,_professional_202605170136.jpeg";
    else if (img === "cabanasUgc") resolvedPath = "products/Product Images/Cabanas/UGC_Cabanas.jpeg";
    else if (img === "gbg2") resolvedPath = "gallery_hotels.png";
    else if (img === "canteenTablesImg") resolvedPath = "products/Product Images/Canteen Table/Create_a_clean,_premium,_professional_202605170053.jpeg";
    else if (img === "canteenTablesUgc") resolvedPath = "products/Product Images/Canteen Table/UGC_Canteen_Table.jpeg";
    else if (img === "canteenTablesHero") resolvedPath = "Canteen_Tables.jpeg";
    else if (img === "carSheltersImg") resolvedPath = "products/Product Images/Car Shed/Create_a_clean,_premium,_professional_202605170216.jpeg";
    else if (img === "carSheltersUgc") resolvedPath = "products/Product Images/Car Shed/UGC_Car_Shelter.jpeg";
    else if (img === "carShelterHero") resolvedPath = "Car_Shelter.jpeg";
    else if (img === "plantersImg") resolvedPath = "products/Product Images/Planters Box/Create_a_clean,_premium,_professional_202605170111.jpeg";
    else if (img === "plantersUgc") resolvedPath = "products/Product Images/Planters Box/UGC_Planters_Box.jpeg";
    else if (img === "plantersBoxHero") resolvedPath = "Planters_Box.jpeg";
    else if (img === "poolsideLoungersImg") resolvedPath = "products/Product Images/Poolside Loungers/Create_a_clean,_premium,_professional_202605170154.jpeg";
    else if (img === "poolsideLoungersUgc") resolvedPath = "products/Product Images/Poolside Loungers/UGC_Poolside_Loungers.jpeg";
    else if (img === "wickerDiningImg") resolvedPath = "products/Product Images/Wicker Dining/wicker_dining.jpeg";
    else if (img === "wickerLivingImg") resolvedPath = "products/Product Images/Wicker Living/Wicker_Living.jpeg";
    else if (img === "wickerDiningUgc") resolvedPath = "products/Product Images/Wicker Dining/UGC_wicker_dining.jpeg";
    else if (img === "busSheltersImg") resolvedPath = "products/Product Images/Bus Shelters/Create_a_clean,_premium,_professional_202605170115.jpeg";
    else if (img === "busSheltersUgc") resolvedPath = "products/Product Images/Bus Shed/Hyper-realistic_8K_ultra_high_resolution_202605281655.jpeg";
    else if (img === "busSheltersRealUgc") resolvedPath = "products/Product Images/Bus Shed/UGC_Bus_Shelters.jpeg";
    else if (img === "dustbinsImg") resolvedPath = "products/Product Images/Dustbins/Create_a_clean,_premium,_professional_202605170106.jpeg";
    else if (img === "dustbinsUgc") resolvedPath = "products/Product Images/Dustbins/UGC_Dustbins.jpeg";
    else if (img === "dustbinsHero") resolvedPath = "Dustbins.jpeg";
    else resolvedPath = "welcome-1.png";

    return `import carouselImg${idx + 1} from "../../assets/${resolvedPath}";`;
  }).join("\n");

  const componentName = pageName.replace(/\s+/g, "") + "Page";
  const labelSuffix = componentName.toLowerCase();
...
const ${componentName} = () => {
    ...
    const [faqOpen, setFaqOpen] = useState(Array(${config.faqList.length}).fill(false));
    ...
    const trackEvent = (eventName, value = "") => {
        if (window.gtag) {
            window.gtag("event", eventName, {
                ...
                event_label: "${labelSuffix}",
                value: value
            });
        }
        console.log(\`[GA4 Event] \${eventName} | Category: product_page | Label: ${labelSuffix} | Value: \${value}\`);
    };

    useEffect(() => {
        updatePageSEO({
            title: "${parsed.metaTitle || componentName}",
            description: "${parsed.metaDesc || 'Premium outdoor solutions'}",
            og_type: "product",
    ...
    const renderStandardTab = () => (
        <div className="animate-fadeIn">
            <div className="mb-6">
                ...
                <h3 className="text-xl sm:text-2xl md:text-3xl font-black uppercase text-[#1A1A1A] mt-3">${config.tabs.standard.title}</h3>
                <h4 className="text-xs sm:text-sm font-semibold uppercase tracking-wider text-[#2D2D2D]/60 mt-1">Best for: ${config.tabs.standard.ideal}</h4>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 border-t border-[#2D2D2D]/10 pt-8">
                ...
                <div className="lg:col-span-1 h-[280px] lg:h-auto rounded-[2rem] bg-black/5 overflow-hidden flex items-center justify-center p-4 border border-black/[0.04] shrink-0">
                    <img 
                        src={carouselImg${config.tabs.standard.imgIdx}} 
                        ...
                        <div className="w-full border border-black/[0.04] rounded-2xl bg-white p-4 sm:p-6 overflow-hidden shadow-sm">
                            <div className="grid grid-cols-1 min-[380px]:grid-cols-2 gap-y-4 gap-x-4 text-xs font-semibold text-[#1A1A1A]">
                                ...
                                <div className="col-span-2 border-t border-black/[0.04] pt-3 mt-1">
                                    ...
                                    <span className="font-bold text-[#2C5F2E]">${config.tabs.standard.matrix.life}</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    const renderPremiumTab = () => (
        <div className="animate-fadeIn">
            <div className="mb-6">
                ...
                <h3 className="text-xl sm:text-2xl md:text-3xl font-black uppercase text-[#1A1A1A] mt-3">${config.tabs.premium.title}</h3>
                <h4 className="text-xs sm:text-sm font-semibold uppercase tracking-wider text-[#2D2D2D]/60 mt-1">Best for: ${config.tabs.premium.ideal}</h4>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 border-t border-[#2D2D2D]/10 pt-8">
                ...
                <div className="lg:col-span-1 h-[280px] lg:h-auto rounded-[2rem] bg-black/5 overflow-hidden flex items-center justify-center p-4 border border-black/[0.04] shrink-0">
                    <img 
                        src={carouselImg${config.tabs.premium.imgIdx}} 
                        alt="Premium variant" 
                        className="w-full h-full object-cover rounded-2xl" 
                    />
                </div>
                    ...
                    <div>
                        ...
                        <div className="w-full border border-black/[0.04] rounded-2xl bg-white p-4 sm:p-6 overflow-hidden shadow-sm">
                            <div className="grid grid-cols-1 min-[380px]:grid-cols-2 gap-y-4 gap-x-4 text-xs font-semibold text-[#1A1A1A]">
                                ...
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Weight</span>
                                    <span className="font-bold">${config.tabs.premium.matrix.wt}</span>
                                </div>
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Lead Time</span>
                                    <span className="font-bold">${config.tabs.premium.matrix.lt}</span>
                                </div>
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Annual Maintenance</span>
                                    <span className="font-bold">${config.tabs.premium.matrix.maint}</span>
                                </div>
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Lifespan</span>
                                    <span className="font-bold text-[#2C5F2E]">${config.tabs.premium.matrix.life}</span>
                                </div>
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Special Rating</span>
                                    <span className="font-bold text-[#2C5F2E]">${config.tabs.premium.matrix.custom}</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    const renderSuperPremiumTab = () => (
        <div className="animate-fadeIn">
            <div className="mb-6">
                ...
                <h3 className="text-xl sm:text-2xl md:text-3xl font-black uppercase text-[#1A1A1A] mt-3">${config.tabs.super.title}</h3>
                <h4 className="text-xs sm:text-sm font-semibold uppercase tracking-wider text-[#2D2D2D]/60 mt-1">Best for: ${config.tabs.super.ideal}</h4>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 border-t border-[#2D2D2D]/10 pt-8">
                ...
                <div className="lg:col-span-1 h-[280px] lg:h-auto rounded-[2rem] bg-black/5 overflow-hidden flex items-center justify-center p-4 border border-black/[0.04] shrink-0">
                    <img 
                        src={carouselImg${config.tabs.super.imgIdx}} 
                    ...
                    <div>
                        ...
                        <div className="w-full border border-black/[0.04] rounded-2xl bg-white p-4 sm:p-6 overflow-hidden shadow-sm">
                            <div className="grid grid-cols-1 min-[380px]:grid-cols-2 gap-y-4 gap-x-4 text-xs font-semibold text-[#1A1A1A]">
                                ...
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Weight</span>
                                    <span className="font-bold">${config.tabs.super.matrix.wt}</span>
                                </div>
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Lead Time</span>
                                    <span className="font-bold">${config.tabs.super.matrix.lt}</span>
                                </div>
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Annual Maintenance</span>
                                    <span className="font-bold">${config.tabs.super.matrix.maint}</span>
                                </div>
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Lifespan</span>
                                    <span className="font-bold text-[#2C5F2E]">${config.tabs.super.matrix.life}</span>
                                </div>
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Tech Features</span>
                                    <span className="font-bold text-[#2C5F2E]">${config.tabs.super.matrix.custom}</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div ref={pageContainerRef} className="w-full bg-[#F7F4EF] text-[#1A1A1A] font-sans pb-24 overflow-x-hidden pt-28">
            ...
            <div className="w-full px-8 md:px-16 py-4 select-none">
                <nav className="flex items-center text-[10px] sm:text-xs font-bold uppercase tracking-widest text-[#2D2D2D]/60 gap-2">
                    ...
                    <span>/</span>
                    <span className="text-[#2C5F2E]">${pageName}</span>
                </nav>
            </div>
            ...
            <section className="max-w-[1400px] 3xl:max-w-[1700px] 4xl:max-w-[2200px] 5xl:max-w-[3000px] mx-auto px-6 md:px-12 mb-24">
                <div className="text-left mb-16 max-w-5xl">
                    ...
                    <p className="text-sm sm:text-base md:text-lg text-[#2D2D2D]/75 leading-relaxed mt-6">
                        ${parsed.introCopy.split('\n')[0] || 'Premium outdoor engineering designed for longevity.'}
                    </p>
                </div>
                        ...
                        <table className="w-full text-left border-collapse min-w-[650px]">
                            ...
                            <tbody className="text-xs font-semibold text-[#1A1A1A]/85">
                                <tr className="border-b border-[#2D2D2D]/10 hover:bg-[#F7F4EF]/45">
                                    ...
                                    <td className="p-5">${config.tabs.standard.matrix.life}</td>
                                    <td className="p-5">${config.tabs.premium.matrix.life}</td>
                                    <td className="p-5">${config.tabs.super.matrix.life}</td>
                                </tr>
                                <tr className="border-b border-[#2D2D2D]/10 hover:bg-[#F7F4EF]/45">
                                    <td className="p-5 font-bold uppercase tracking-wider bg-[#2C5F2E]/5">Lead Time</td>
                                    <td className="p-5">${config.tabs.standard.matrix.lt}</td>
                                    <td className="p-5">${config.tabs.premium.matrix.lt}</td>
                                    <td className="p-5">${config.tabs.super.matrix.lt}</td>
                                </tr>
                                <tr className="border-b border-[#2D2D2D]/10 hover:bg-[#F7F4EF]/45">
            ...
            <section id="specifications" className="max-w-[1400px] 3xl:max-w-[1700px] 4xl:max-w-[2200px] 5xl:max-w-[3000px] mx-auto px-6 md:px-12 mb-24">
                ...
                <div className="w-full overflow-x-auto border border-black/[0.04] rounded-3xl bg-white shadow-sm mb-12 scrollbar-thin">
                    <table className="w-full text-left border-collapse min-w-[650px]">
                        ...
                        <tbody className="text-xs font-semibold text-[#1A1A1A]/85">
                            {${JSON.stringify(config.materials)}.map((m, idx) => (
            ...
            <section className="max-w-[1400px] 3xl:max-w-[1700px] 4xl:max-w-[2200px] 5xl:max-w-[3000px] mx-auto px-6 md:px-12 mb-24">
                ...
                <div className="bg-[#2D2D2D] rounded-[2rem] border border-white/5 p-8 md:p-10 text-white flex flex-col md:flex-row justify-between items-center text-center gap-8 shadow-md">
                    <div className="flex-1">
                        <span className="block text-3xl font-black uppercase tracking-tight text-[#C9A84C]">${config.stats.p}</span>
                        <span className="text-[9px] sm:text-[10px] uppercase font-bold tracking-widest text-white/55 mt-1 block">${config.stats.pLbl}</span>
                    </div>
                    <div className="w-[1px] h-8 bg-white/10 md:block hidden" />
                    <div className="flex-1">
                        <span className="block text-3xl font-black uppercase tracking-tight text-[#C9A84C]">${config.stats.c}</span>
                        <span className="text-[9px] sm:text-[10px] uppercase font-bold tracking-widest text-white/55 mt-1 block">${config.stats.cLbl}</span>
                    </div>
                    <div className="w-[1px] h-8 bg-white/10 md:block hidden" />
                    <div className="flex-1">
                        <span className="block text-3xl font-black uppercase tracking-tight text-[#C9A84C]">${config.stats.o}</span>
                        <span className="text-[9px] sm:text-[10px] uppercase font-bold tracking-widest text-white/55 mt-1 block">${config.stats.oLbl}</span>
                    </div>
                </div>
            </section>
...
// Generate the files
const summaryPath = "C:/Users/ks209/Documents/kawaki clients/urbanland/urbanv2-main/urbanv2-main/frontend/src/constants/docx_content_summary.txt";
const fileText = fs.readFileSync(summaryPath, 'utf8');
const docxBlocks = fileText.split("=== FILE: ");
const productsBaseDir = "C:/Users/ks209/Documents/kawaki clients/urbanland/urbanv2-main/urbanv2-main/frontend/src/pages/Products";
