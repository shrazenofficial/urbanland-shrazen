...
const ${componentName} = () => {
    ...
    const handlePrevProject = () => {
        setProjectSlideIdx((prev) => (prev - 1 + ${config.projects.length}) % ${config.projects.length});
    };

    const handleNextProject = () => {
        setProjectSlideIdx((prev) => (prev + 1) % ${config.projects.length});
    };

    const configCards = [
        { key: "standard", data: ${JSON.stringify(config.tabs.standard)}, badge: "Value Option" },
        { key: "premium", data: ${JSON.stringify(config.tabs.premium)}, badge: "Most Specified" },
        { key: "super", data: ${JSON.stringify(config.tabs.super)}, badge: "Smart Ready" }
    ];
        ...
        <div ref={pageContainerRef} className="w-full bg-[#F7F4EF] text-[#1A1A1A] font-sans pb-24 overflow-x-hidden pt-28">
            ...
            <div className="max-w-[1280px] mx-auto px-6 md:px-12 py-4 select-none">
                <nav className="flex items-center text-[10px] sm:text-xs font-bold uppercase tracking-widest text-[#2C5F2E] gap-2">
                    ...
                    <span>/</span>
                    <span className="text-[#C9A84C]">${pageName}</span>
                </nav>
            </div>
                ...
                <div className="max-w-[1280px] mx-auto px-6 md:px-12 w-full grid grid-cols-1 lg:grid-cols-2 gap-6 relative z-10">
                    ...
                    <div className="flex flex-col justify-center space-y-8 py-20 lg:py-24 text-left">
                        ...
                        <p className="font-body-lg text-[18px] text-[#44474A] max-w-lg leading-relaxed">
                            ${parsed.introCopy.split('\n')[0] || 'Premium outdoor and urban solutions designed for longevity.'}
                        </p>
                        ...
                        <div className="flex flex-wrap items-center gap-x-6 gap-y-3 pt-4 border-t border-[#DCDAD5]">
                            ...
                            <div className="flex items-center space-x-2 text-[#44474A]">
                                ...
                                <span className="font-label-technical text-[12px]">${config.stats.p} Projects Delivered</span>
                            </div>
                        </div>
            ...
            <section className="bg-[#F7F4EF] py-24 px-6 md:px-12 border-b border-[#C9A84C] transition-all duration-1000 opacity-100 translate-y-0">
                <div className="max-w-[1280px] mx-auto text-left">
                    <div className="mb-16 text-left space-y-4">
                        <h2 className="font-headline-lg text-[32px] text-[#1A1A1A] text-left">Why Quality ${pageName} Matter in Public & Outdoor Spaces</h2>
            ...
            <section className="bg-[#F7F4EF] py-24 px-6 md:px-12 border-b border-[#C9A84C] transition-all duration-1000 opacity-100 translate-y-0">
                <div className="max-w-[1280px] mx-auto">
                    <div className="mb-16 space-y-4 text-left">
                        <h2 className="font-headline-lg text-[32px] text-[#1A1A1A] text-left">Three ${pageName} Configurations — Choose What Fits Your Project</h2>
                        <div className="w-24 h-1 bg-[#C9A84C]"></div>
                        <p className="font-body-lg text-[18px] text-[#44474A] max-w-3xl">
                        ...
                        {configCards.map((card, idx) => (
                            <div key={card.key} className="bg-[#F2F0EB] border border-[#DCDAD5] rounded-none transition-all group p-0 flex flex-col justify-between overflow-hidden text-left">
                                ...
                                <div className="p-8 pt-0">
                                    <Link to={"/get-quote/?product=${config.routePath.split('/').pop()}&variant=" + card.key} className="bg-[#2C5F2E] text-white px-6 py-3 font-label-technical uppercase tracking-widest text-xs inline-block text-center rounded-[4px] border-b-2 border-[#1A1A1A] hover:bg-[#C9A84C] hover:text-[#1A1C1E] transition-colors w-full">
            ...
            <section className="bg-[#F7F4EF] py-24 px-6 md:px-12 border-b border-[#C9A84C] transition-all duration-1000 opacity-100 translate-y-0">
                <div className="max-w-[1280px] mx-auto">
                    <div className="mb-16 space-y-4 text-left">
                        ...
                        <p className="font-label-technical text-[#2C5F2E] uppercase tracking-widest font-bold">${config.stats.p} major projects delivered | ${config.stats.c} cities served</p>
                    </div>
                    ...
                    <div className="bg-[#2C5F2E] text-white p-6 md:p-10 mb-20 flex flex-col md:flex-row gap-6 md:gap-10 items-center rounded-none">
                        <div className="md:w-1/2 space-y-6 text-left">
                            ...
                            <h3 className="font-headline-md text-[24px] text-white leading-tight text-left">${config.tabs.premium.title}</h3>
                            <p className="font-body-lg opacity-90 leading-relaxed">
                                ${config.tabs.premium.ideal} Featuring ${config.tabs.premium.features.join(", ")}.
                            </p>
                        </div>
