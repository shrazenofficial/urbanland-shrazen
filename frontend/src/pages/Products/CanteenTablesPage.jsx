...
const CanteenTablesPage = () => {
    ...
    const configCards = [
        { key: "standard", data: {"title":"Standard 4-Seater Canteen Set — Compact & Sturdy","ideal":"Factory breakrooms, school lunchrooms, budget outdoor cafeterias.","features":["Frame: Mild Steel with industrial powder coating","Table/Seat top: Durable pre-laminated MDF board (indoor only)","Design: Connected 4-seat bench configuration","Capacity: 4 persons"],"imgIdx":1,"matrix":{"dims":"1200L × 1600W × 750H mm","wt":"50-60 kg","lt":"20-25 days","maint":"Moderate","life":"5-6 years","custom":"None"}}, badge: "Value Option" },
        { key: "premium", data: {"title":"Premium Morse Canteen Set — All-Weather HPL","ideal":"Corporate IT park courtyards, university outdoor plazas, premium office cafes.","features":["Frame: Galvanized steel with architectural powder coating","Table/Seat top: 12mm High-Pressure Laminate (HPL) panels with drainage slots","Design: Connected 6-seat table and bench set","Capacity: 6 persons"],"imgIdx":2,"matrix":{"dims":"1800L × 1600W × 750H mm","wt":"80-95 kg","lt":"25-30 days","maint":"Zero (periodic wipe)","life":"10-12 years","custom":"Surface mount anchor bolt flanging"}}, badge: "Most Specified" },
        { key: "super", data: {"title":"Super Premium SS 316 Cafeteria Set — Marine Grade","ideal":"Oceanfront cafes, chemical laboratory canteens, heavy-duty outdoor plazas.","features":["Frame: Stainless Steel 316 (brushed or mirror finish)","Table/Seat top: Solid Stainless Steel slatted or perforated sheets","Design: Connected 8-seat double table configuration","Capacity: 8 persons"],"imgIdx":3,"matrix":{"dims":"2200L × 1600W × 750H mm","wt":"130-155 kg","lt":"30-40 days","maint":"Zero","life":"20+ years indefinite","custom":"Custom corporate logo engraving ready"}}, badge: "Smart Ready" }
    ];
        ...
        <div ref={pageContainerRef} className="w-full bg-[#F7F4EF] text-[#1A1A1A] font-sans pb-24 overflow-x-hidden pt-28">
            ...
            <div className="max-w-[1280px] mx-auto px-6 md:px-12 py-4 select-none">
                <nav className="flex items-center text-[10px] sm:text-xs font-bold uppercase tracking-widest text-[#2C5F2E] gap-2">
                    ...
                    <span>/</span>
                    <span className="text-[#C9A84C]">Canteen Tables</span>
                </nav>
            </div>
                    ...
                    <div className="flex flex-col justify-center space-y-8 py-20 lg:py-24 text-left">
                        <div className="space-y-4">
                            <span className="font-label-technical text-[#C9A84C] tracking-[0.2em] uppercase font-semibold block mb-4">
                                Urbanland Products presents premium canteen tables designed to elevate your dining experience. Meticulously crafted, they blend durability with contemporary style for any urban setting. Discover the perfect mix of strength and elegance with our canteen tables.
                            </span>
                            <h1 className="font-headline-xl text-[38px] font-[700] md:text-[48px] text-[#1A1A1A] max-w-xl leading-[1.2] md:leading-[1.1] text-left">
                                Premium Canteen Tables Manufacturer in India – Durable & Stylish Cafeteria Tables
                            </h1>
                        </div>
                        ...
                        <div className="relative h-full lg:h-[97%] w-full">
                            ...
                            <div className="relative h-full min-h-[600px] w-full overflow-hidden border border-[#DCDAD5] bg-[#E8E6E0] rounded-none">
                                {carouselImages.map((img, idx) => (
                                    <img
                                        key={idx}
                                        alt={"Premium Canteen Tables " + (idx + 1)}
            ...
            <section className="bg-[#F7F4EF] py-24 px-6 md:px-12 border-b border-[#C9A84C] transition-all duration-1000 opacity-100 translate-y-0">
                <div className="max-w-[1280px] mx-auto text-left">
                    <div className="mb-16 text-left space-y-4">
                        <h2 className="font-headline-lg text-[32px] text-[#1A1A1A] text-left">Why Quality Canteen Tables Matter in Public & Outdoor Spaces</h2>
            ...
            <section className="bg-[#F7F4EF] py-24 px-6 md:px-12 border-b border-[#C9A84C] transition-all duration-1000 opacity-100 translate-y-0">
                <div className="max-w-[1280px] mx-auto">
                    <div className="mb-16 space-y-4 text-left">
                        <h2 className="font-headline-lg text-[32px] text-[#1A1A1A] text-left">Three Canteen Tables Configurations — Choose What Fits Your Project</h2>
                        <div className="w-24 h-1 bg-[#C9A84C]"></div>
                        <p className="font-body-lg text-[18px] text-[#44474A] max-w-3xl">
                        ...
                        {configCards.map((card, idx) => (
                            <div key={card.key} className="bg-[#F2F0EB] border border-[#DCDAD5] rounded-none transition-all group p-0 flex flex-col justify-between overflow-hidden text-left">
                                ...
                                <div className="p-8 pt-0">
                                    <Link to={"/get-quote/?product=canteen-tables&variant=" + card.key} className="bg-[#2C5F2E] text-white px-6 py-3 font-label-technical uppercase tracking-widest text-xs inline-block text-center rounded-[4px] border-b-2 border-[#1A1A1A] hover:bg-[#C9A84C] hover:text-[#1A1C1E] transition-colors w-full">
                ...
                <div className="max-w-[1280px] mx-auto">
                    ...
                    <div className="bg-[#2C5F2E] text-white p-6 md:p-10 mb-20 flex flex-col md:flex-row gap-6 md:gap-10 items-center rounded-none">
                        <div className="md:w-1/2 space-y-6 text-left">
                            ...
                            <h3 className="font-headline-md text-[24px] text-white leading-tight text-left">Premium Morse Canteen Set — All-Weather HPL</h3>
                            <p className="font-body-lg opacity-90 leading-relaxed">
                                Corporate IT park courtyards, university outdoor plazas, premium office cafes. Featuring Frame: Galvanized steel with architectural powder coating, Table/Seat top: 12mm High-Pressure Laminate (HPL) panels with drainage slots, Design: Connected 6-seat table and bench set, Capacity: 6 persons.
                            </p>
                        </div>
