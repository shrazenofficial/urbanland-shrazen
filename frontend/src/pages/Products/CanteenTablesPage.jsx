...
import carouselImg1 from "../../assets/products/Product Images/Canteen Table/Create_a_clean,_premium,_professional_202605170053.jpeg";
import carouselImg2 from "../../assets/products/Product Images/Canteen Table/UGC_Canteen_Table.jpeg";
import carouselImg3 from "../../assets/Canteen_Tables.jpeg";
    ...
    const trackEvent = (eventName, value = "") => {
        if (window.gtag) {
            window.gtag("event", eventName, {
                ...
                event_label: "canteentablespage",
                value: value
            });
        }
        console.log(`[GA4 Event] ${eventName} | Category: product_page | Label: canteentablespage | Value: ${value}`);
    };
    ...
    const renderStandardTab = () => (
        <div className="animate-fadeIn">
            <div className="mb-6">
                ...
                <h3 className="text-xl sm:text-2xl md:text-3xl font-black uppercase text-[#1A1A1A] mt-3">Standard 4-Seater Canteen Set — Compact & Sturdy</h3>
                <h4 className="text-xs sm:text-sm font-semibold uppercase tracking-wider text-[#2D2D2D]/60 mt-1">Best for: Factory breakrooms, school lunchrooms, budget outdoor cafeterias.</h4>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 border-t border-[#2D2D2D]/10 pt-8">
                <div>
                    ...
                    <ul className="flex flex-col gap-3 text-xs sm:text-sm font-semibold text-[#1A1A1A]/85">
                        {["Frame: Mild Steel with industrial powder coating","Table/Seat top: Durable pre-laminated MDF board (indoor only)","Design: Connected 4-seat bench configuration","Capacity: 4 persons"].map((f, idx) => (
                    ...
                    <p className="text-xs sm:text-sm text-[#2D2D2D]/75 font-semibold leading-relaxed">
                        Factory breakrooms, school lunchrooms, budget outdoor cafeterias.
                    </p>
                </div>
                        ...
                        <div className="w-full border border-black/[0.04] rounded-2xl bg-white p-4 sm:p-6 overflow-hidden shadow-sm">
                            <div className="grid grid-cols-1 min-[380px]:grid-cols-2 gap-y-4 gap-x-4 text-xs font-semibold text-[#1A1A1A]">
                                <div>
                                    ...
                                    <span className="font-bold">1200L × 1600W × 750H mm</span>
                                </div>
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Weight</span>
                                    <span className="font-bold">50-60 kg</span>
                                </div>
                                <div>
    ...
    const renderPremiumTab = () => (
        <div className="animate-fadeIn">
            <div className="mb-6">
                ...
                <h3 className="text-xl sm:text-2xl md:text-3xl font-black uppercase text-[#1A1A1A] mt-3">Premium Morse Canteen Set — All-Weather HPL</h3>
                <h4 className="text-xs sm:text-sm font-semibold uppercase tracking-wider text-[#2D2D2D]/60 mt-1">Best for: Corporate IT park courtyards, university outdoor plazas, premium office cafes.</h4>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 border-t border-[#2D2D2D]/10 pt-8">
                <div>
                    <h4 className="text-[0.8125rem] md:text-sm font-black uppercase tracking-widest text-[#2C5F2E] mb-4 select-none">— Key Features</h4>
                    <ul className="flex flex-col gap-3 text-xs sm:text-sm font-semibold text-[#1A1A1A]/85">
                        {["Frame: Galvanized steel with architectural powder coating","Table/Seat top: 12mm High-Pressure Laminate (HPL) panels with drainage slots","Design: Connected 6-seat table and bench set","Capacity: 6 persons"].map((f, idx) => (
                            <li key={idx} className="flex items-center gap-3"><span className="text-[#C9A84C]">▸</span> {f}</li>
                        ))}
                    </ul>
                    ...
                    <h4 className="text-[0.8125rem] md:text-sm font-black uppercase tracking-widest text-[#2C5F2E] mt-10 mb-4 select-none">— Ideal For</h4>
                    <p className="text-xs sm:text-sm text-[#2D2D2D]/75 font-semibold leading-relaxed">
                        Corporate IT park courtyards, university outdoor plazas, premium office cafes.
                    </p>
                </div>
                    ...
                    <div>
                        ...
                        <div className="w-full border border-black/[0.04] rounded-2xl bg-white p-4 sm:p-6 overflow-hidden shadow-sm">
                            <div className="grid grid-cols-1 min-[380px]:grid-cols-2 gap-y-4 gap-x-4 text-xs font-semibold text-[#1A1A1A]">
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Dimensions</span>
                                    <span className="font-bold">1800L × 1600W × 750H mm</span>
                                </div>
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Weight</span>
                                    <span className="font-bold">80-95 kg</span>
                                </div>
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Lead Time</span>
                                ...
                                <div>
                                    ...
                                    <span className="font-bold text-[#2C5F2E]">Surface mount anchor bolt flanging</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    const renderSuperPremiumTab = () => (
        <div className="animate-fadeIn">
            <div className="mb-6">
                ...
                <h3 className="text-xl sm:text-2xl md:text-3xl font-black uppercase text-[#1A1A1A] mt-3">Super Premium SS 316 Cafeteria Set — Marine Grade</h3>
                <h4 className="text-xs sm:text-sm font-semibold uppercase tracking-wider text-[#2D2D2D]/60 mt-1">Best for: Oceanfront cafes, chemical laboratory canteens, heavy-duty outdoor plazas.</h4>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 border-t border-[#2D2D2D]/10 pt-8">
                <div>
                    <h4 className="text-[0.8125rem] md:text-sm font-black uppercase tracking-widest text-[#2C5F2E] mb-4 select-none">— Key Features</h4>
                    <ul className="flex flex-col gap-3 text-xs sm:text-sm font-semibold text-[#1A1A1A]/85">
                        {["Frame: Stainless Steel 316 (brushed or mirror finish)","Table/Seat top: Solid Stainless Steel slatted or perforated sheets","Design: Connected 8-seat double table configuration","Capacity: 8 persons"].map((f, idx) => (
                            <li key={idx} className="flex items-center gap-3"><span className="text-[#C9A84C]">▸</span> {f}</li>
                        ))}
                    </ul>
                    ...
                    <h4 className="text-[0.8125rem] md:text-sm font-black uppercase tracking-widest text-[#2C5F2E] mt-10 mb-4 select-none">— Ideal For</h4>
                    <p className="text-xs sm:text-sm text-[#2D2D2D]/75 font-semibold leading-relaxed">
                        Oceanfront cafes, chemical laboratory canteens, heavy-duty outdoor plazas.
                    </p>
                </div>
                    ...
                    <div>
                        ...
                        <div className="w-full border border-black/[0.04] rounded-2xl bg-white p-4 sm:p-6 overflow-hidden shadow-sm">
                            <div className="grid grid-cols-1 min-[380px]:grid-cols-2 gap-y-4 gap-x-4 text-xs font-semibold text-[#1A1A1A]">
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Dimensions</span>
                                    <span className="font-bold">2200L × 1600W × 750H mm</span>
                                </div>
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Weight</span>
                                    <span className="font-bold">130-155 kg</span>
                                </div>
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Lead Time</span>
                                ...
                                <div>
                                    ...
                                    <span className="font-bold text-[#2C5F2E]">Custom corporate logo engraving ready</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div ref={pageContainerRef} className="w-full bg-[#F7F4EF] text-[#1A1A1A] font-sans pb-24 overflow-x-hidden pt-28">
            ...
            <div className={`fixed top-0 left-0 w-full bg-white/95 backdrop-blur-md border-b border-[#2D2D2D]/10 py-4 px-8 lg:px-16 z-[99] flex justify-between items-center transition-all duration-500 shadow-md ${showStickyHeader ? "translate-y-0 opacity-100" : "-translate-y-full opacity-0 pointer-events-none"}`}>
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-[10px] uppercase font-bold tracking-widest text-[#2D2D2D]/50 hidden sm:inline">Canteen Tables</span>
                </div>
                <Link
                    to="/get-quote/?product=canteen-tables"
            ...
            <div className="max-w-[1400px] 3xl:max-w-[1700px] 4xl:max-w-[2200px] 5xl:max-w-[3000px] mx-auto px-6 md:px-12 py-4 select-none">
                <nav className="flex items-center text-[10px] sm:text-xs font-bold uppercase tracking-widest text-[#2D2D2D]/60 gap-2">
                    ...
                    <span>/</span>
                    <span className="text-[#2C5F2E]">Canteen Tables</span>
                </nav>
            </div>
            ...
            <section className="w-full mb-8 relative select-none">
                ...
                >
                    {[{"tag":"Product Spotlight","h":"Heavy-Duty Canteen<br />Tables & Dining Sets","label":"01","desc":"Integrated seating and tables for high-traffic zones"},{"tag":"Campus & Workplace","h":"Vandal-resistant<br />cafeteria seating<br />configurations","label":"02","desc":"High-Pressure Laminate (HPL) panel tops"},{"tag":"B2B Guarantee","h":"2-Year Warranty<br />& ISO Certified<br />Standards","label":"03","desc":"Trusted by top colleges, factories & corporate offices"},{"tag":"Weather Resistant","h":"Galvanized Steel<br />frames with anti-pooling<br />drainage slots","label":"04","desc":"Perfect for indoor and outdoor al-fresco dining"},{"tag":"Bespoke Layouts","h":"Custom 4, 6, and<br />8-seater connected<br />canteen configurations","label":"05","desc":"Designed for optimal space utilization"}].map((card, idx) => (
            ...
            <section className="max-w-[1400px] 3xl:max-w-[1700px] 4xl:max-w-[2200px] 5xl:max-w-[3000px] mx-auto px-6 md:px-12 mb-24">
                <div className="text-left mb-16 max-w-5xl">
                    ...
                    <p className="text-sm sm:text-base md:text-lg text-[#2D2D2D]/75 leading-relaxed mt-6">
                        Why People Choose Urbanland Products for Canteen Tables
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 select-none">
                    {[{"title":"Vandal-Resistant","desc":"Features integrated connected seating and tamper-proof security bolts, preventing seat theft and misalignments."},{"title":"Low Maintenance","desc":"High-Pressure Laminate (HPL) or stainless steel tops are stain-resistant, oil-resistant, and easily wiped clean."},{"title":"Anti-Pooling Top","desc":"Designed with subtle slope or drainage slots in table/bench surfaces, allowing rain water to drain off instantly."},{"title":"Heavy Weight Stability","desc":"Weighted steel frames with bolt-down flanges prevent tables from tipping over or shifting in busy cafeterias."}].map((r, idx) => (
            ...
            <section className="max-w-[1400px] 3xl:max-w-[1700px] 4xl:max-w-[2200px] 5xl:max-w-[3000px] mx-auto px-6 md:px-12 mb-24">
                <div className="text-left mb-12 max-w-4xl">
                    ...
                    <h2 className="text-3xl sm:text-5xl font-black uppercase tracking-tight leading-none text-[#1A1A1A]">
                        Three Canteen Tables Configurations — Choose What Fits Your Project
                    </h2>
            ...
            <section id="specifications" className="max-w-[1400px] 3xl:max-w-[1700px] 4xl:max-w-[2200px] 5xl:max-w-[3000px] mx-auto px-6 md:px-12 mb-24">
                ...
                <div className="w-full overflow-x-auto border border-black/[0.04] rounded-3xl bg-white shadow-sm mb-12 scrollbar-thin">
                    <table className="w-full text-left border-collapse min-w-[650px]">
                        ...
                        <tbody className="text-xs font-semibold text-[#1A1A1A]/85">
                            {[{"name":"High-Pressure Laminate (HPL)","life":"10-12 years","maint":"Zero maintenance","best":"All-weather outdoor canteens","cost":"Moderate (1.3x vs wood)"},{"name":"Pre-laminated Board","life":"3-5 years","maint":"Prevent water exposure","best":"Indoor dry canteens","cost":"Economical (0.7x)"},{"name":"Stainless Steel 304/316","life":"20+ years","maint":"Wipe with cleaner","best":"Corrosive or hygienic laboratory environments","cost":"Premium (2.5x vs HPL)"}].map((m, idx) => (
                ...
                <div className="bg-white rounded-[2.5rem] border border-black/[0.03] p-8 md:p-12 mb-12 shadow-sm">
                    <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs sm:text-sm font-bold text-[#1A1A1A]/85">
                        {["Configuration: 4-seater (square), 6-seater (rectangular), 8-seater, or modular linked canteen rows","Table/Seat top: Architectural HPL panels, solid stainless steel, Robinia timber, or composite WPC","Frame Finish: Textured powder coating, brushed steel, polished chrome, or galvanized steel","Add-ons: Integrated umbrella holder holes, backrests on benches, or central divider panels","Mounting: Expansion bolt down, core drilling grouted legs, or adjustable heavy rubber feet"].map((c, idx) => (
            ...
            <section className="max-w-[1400px] 3xl:max-w-[1700px] 4xl:max-w-[2200px] 5xl:max-w-[3000px] mx-auto px-6 md:px-12 mb-24">
                ...
                <div className="bg-[#2D2D2D] rounded-[2rem] border border-white/5 p-8 md:p-10 text-white flex flex-col md:flex-row justify-between items-center text-center gap-8 shadow-md">
                    <div className="flex-1">
                        <span className="block text-3xl font-black uppercase tracking-tight text-[#C9A84C]">60+</span>
                        <span className="text-[9px] sm:text-[10px] uppercase font-bold tracking-widest text-white/55 mt-1 block">Major B2B Cafeterias Delivered</span>
                    </div>
                    <div className="w-[1px] h-8 bg-white/10 md:block hidden" />
                    <div className="flex-1">
                        <span className="block text-3xl font-black uppercase tracking-tight text-[#C9A84C]">20+</span>
                        <span className="text-[9px] sm:text-[10px] uppercase font-bold tracking-widest text-white/55 mt-1 block">Cities Served</span>
                    </div>
                    <div className="w-[1px] h-8 bg-white/10 md:block hidden" />
                    <div className="flex-1">
                        <span className="block text-3xl font-black uppercase tracking-tight text-[#C9A84C]">3000+</span>
                        <span className="text-[9px] sm:text-[10px] uppercase font-bold tracking-widest text-white/55 mt-1 block">Dining Sets Installed</span>
                    </div>
                </div>
            </section>
            ...
            <section className="max-w-[1400px] 3xl:max-w-[1700px] 4xl:max-w-[2200px] 5xl:max-w-[3000px] mx-auto px-6 md:px-12 mb-24">
                ...
                <div className="flex flex-col gap-4 max-w-4xl mx-auto">
                    {[{"q":"Which material is best for high-traffic canteens?","a":"Stainless Steel frames combined with High-Pressure Laminate (HPL) tops offer the best hygiene, cleaning efficiency, and durability."},{"q":"Can tables be customized for specific seating capacity?","a":"Yes. We manufacture standard 4-seater, 6-seater, and 8-seater configurations, as well as custom connected bench layouts."},{"q":"Are your canteen tables suitable for outdoor use?","a":"Yes. When constructed with powder-coated galvanized steel or SS frames and outdoor-grade HPL panels, they are 100% weather-resistant."},{"q":"What is the typical lead time?","a":"Normal fabrication lead time is 25-30 days from layout approval."},{"q":"Do you provide installation services?","a":"Yes, we provide nationwide delivery and installation for corporate offices, colleges, and factories."}].map((faq, idx) => (
                        <div 
                            key={idx} 
            ...
            {/* FINAL CTA SECTION */}
            <CTASection 
                title="Ready to Specify Canteen Tables for Your Project?"
                primaryLink="/get-quote/?product=canteen-tables"
            />
        </div>
    );
};
