            ...
            <section className="w-full mb-8 relative select-none">
                ...
                >
                    ...
                    <div className="flex-shrink-0 w-[90vw] sm:w-[65vw] md:w-[48vw] lg:w-[32.5vw] aspect-[3/4.2] min-h-[520px] md:min-h-[620px] rounded-[2.5rem] md:rounded-[3rem] overflow-hidden flex flex-col justify-between p-8 md:p-10 relative group transition-all duration-500 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.1)] hover:shadow-2xl hover:-translate-y-1 border border-black/5">
                        ...
                        <img 
                            src={busImg} 
                            alt="Premium smart bus shelters manufactured in India" 
                        ...
                        <div className="z-10">
                            ...
                            <h3 className="text-3xl md:text-[2.6rem] font-light uppercase tracking-tight text-white leading-[1.05] font-sans">
                                Premium Smart<br />Bus Shelters<br />in India
                            </h3>
                        </div>
                        ...
                        <div className="z-10 flex justify-between items-end w-full">
                            <span className="text-[11px] font-bold tracking-wide text-white/90 uppercase">
                                <span className="font-black mr-2 text-[#C9A84C]">01</span>High-durability MS & SS stop designs
                            </span>
                        </div>
                    </div>
                    ...
                    <div className="flex-shrink-0 w-[90vw] sm:w-[65vw] md:w-[48vw] lg:w-[32.5vw] aspect-[3/4.2] min-h-[520px] md:min-h-[620px] rounded-[2.5rem] md:rounded-[3rem] overflow-hidden flex flex-col justify-between p-8 md:p-10 relative group transition-all duration-500 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.1)] hover:shadow-2xl hover:-translate-y-1 border border-black/5">
                        ...
                        <img 
                            src={busJpeg} 
                            alt="Modern transit stops with integrated seating and safety glass" 
                            className="absolute inset-0 w-full h-full object-cover transform transition-transform duration-700 group-hover:scale-105"
                        />
                        {/* Overlays */}
                        <div className="absolute inset-0 bg-gradient-to-b from-black/45 via-transparent to-black/55 pointer-events-none" />
                        ...
                        <div className="z-10">
                            <h3 className="text-3xl md:text-[2.6rem] font-light uppercase tracking-tight text-white leading-[1.05] font-sans">
                                Modern Transit<br />Stops with safety<br />glass options
                            </h3>
                        </div>

                        <div className="z-10 flex justify-between items-end w-full">
                            <span className="text-[11px] font-bold tracking-wide text-white/90 uppercase">
                                <span className="font-black mr-2 text-[#C9A84C]">02</span>Weatherproof toughened windguards
                            </span>
                        </div>
                    </div>
                    ...
                    <div className="flex-shrink-0 w-[90vw] sm:w-[65vw] md:w-[48vw] lg:w-[32.5vw] aspect-[3/4.2] min-h-[520px] md:min-h-[620px] rounded-[2.5rem] md:rounded-[3rem] overflow-hidden flex flex-col justify-between p-8 md:p-10 relative group transition-all duration-500 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.1)] hover:shadow-2xl hover:-translate-y-1 border border-black/5">
                        ...
                        <img 
                            src={benchImg} 
                            alt="Concealed concrete anchoring systems and robust designs" 
                            className="absolute inset-0 w-full h-full object-cover transform transition-transform duration-700 group-hover:scale-105"
                        />
                        {/* Overlays */}
                        <div className="absolute inset-0 bg-gradient-to-b from-black/45 via-transparent to-black/55 pointer-events-none" />
                        ...
                        <div className="z-10 flex justify-between items-end w-full">
                            <span className="text-[11px] font-bold tracking-wide text-white/90 uppercase">
                                <span className="font-black mr-2 text-[#C9A84C]">03</span>Trusted across 50+ smart townships
                            </span>
                    ...
                    <div className="flex-shrink-0 w-[90vw] sm:w-[65vw] md:w-[48vw] lg:w-[32.5vw] aspect-[3/4.2] min-h-[520px] md:min-h-[620px] rounded-[2.5rem] md:rounded-[3rem] overflow-hidden flex flex-col justify-between p-8 md:p-10 relative group transition-all duration-500 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.1)] hover:shadow-2xl hover:-translate-y-1 border border-black/5">
                        ...
                        <img 
                            src={carImg} 
                            alt="Hot-dip galvanized structural frames and wind load resistance" 
                            className="absolute inset-0 w-full h-full object-cover transform transition-transform duration-700 group-hover:scale-105"
                        />
                        {/* Overlays */}
                        <div className="absolute inset-0 bg-gradient-to-b from-black/45 via-transparent to-black/55 pointer-events-none" />
                        ...
                        <div className="z-10">
                            <h3 className="text-3xl md:text-[2.6rem] font-light uppercase tracking-tight text-white leading-[1.05] font-sans">
                                High-Strength<br />Modular Custom<br />Engineering
                            </h3>
                        </div>

                        <div className="z-10 flex justify-between items-end w-full">
                            <span className="text-[11px] font-bold tracking-wide text-white/90 uppercase">
                                <span className="font-black mr-2 text-[#C9A84C]">04</span>Windload certified structural assemblies
                            </span>
                        </div>
                    </div>
                    ...
                    <div className="flex-shrink-0 w-[90vw] sm:w-[65vw] md:w-[48vw] lg:w-[32.5vw] aspect-[3/4.2] min-h-[520px] md:min-h-[620px] rounded-[2.5rem] md:rounded-[3rem] overflow-hidden flex flex-col justify-between p-8 md:p-10 relative group transition-all duration-500 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.1)] hover:shadow-2xl hover:-translate-y-1 border border-black/5">
                        ...
                        <img 
                            src={busImg} 
                            alt="Solar paneled lighting and pre-wired IoT sensor stops" 
                            className="absolute inset-0 w-full h-full object-cover transform transition-transform duration-700 group-hover:scale-105"
                        />
                        {/* Overlays */}
                        <div className="absolute inset-0 bg-gradient-to-b from-black/45 via-transparent to-black/55 pointer-events-none" />
                        ...
                        <div className="z-10">
                            <h3 className="text-3xl md:text-[2.6rem] font-light uppercase tracking-tight text-white leading-[1.05] font-sans">
                                Smart City IoT<br />Ready & Solar<br />Powered Stops
                            </h3>
                        </div>

                        <div className="z-10 flex justify-between items-end w-full">
                            <span className="text-[11px] font-bold tracking-wide text-white/90 uppercase">
                                <span className="font-black mr-2 text-[#C9A84C]">05</span>Integrated USB ports and motion LEDs
                            </span>
                        </div>
                    </div>
                </div>
