...
const WickerFurniturePage = () => {
    ...
    const configCards = [
        { key: "standard", data: {"title":"Standard Wicker Chair & Table Set — Bistro Style","ideal":"Residential balconies, small cafe patios, society clubhouse decks.","features":["Frame: Powder coated steel with PE cane weave","Fabric: Standard water-resistant polyester","Design: 2x Armchairs, 1x Circular glass top side table","Capacity: Standard residential seating load"],"imgIdx":1,"matrix":{"dims":"Chair: 600W × 600D × 850H mm","wt":"18 kg (total set)","lt":"25-30 days","maint":"Low (hose down clean)","life":"5-6 years","custom":"None"}}, badge: "Value Option" },
        { key: "premium", data: {"title":"Premium Wicker Dining Set — Resort Collection","ideal":"Hotel rooftop dining, open-air resort restaurants, large villa terraces.","features":["Frame: Structural anodized aluminium under-chassis","Body Wrap: High-grade HDPE wicker flat weave","Cushions: 50mm quick-dry foam seat pads with Sunbrella covers","Design: 6x Dining armchairs, 1x Rectangular dining table (tempered glass top)"],"imgIdx":2,"matrix":{"dims":"Table: 1800L × 900W × 750H mm","wt":"65 kg (total set)","lt":"30-45 days","maint":"Seasonal fabric wash","life":"8-10 years","custom":"Tempered glass table top protector"}}, badge: "Most Specified" },
        { key: "super", data: {"title":"Super Premium Modular Sofa Lounge — Island Style","ideal":"Luxury beach clubs, resort lobbies, premium executive rooftop decks.","features":["Frame: Heavy structural aluminium wrapped in synthetic PE rope weave","Body Wrap: Thick round PE wicker or synthetic rope weave","Cushions: 120mm plush quick-dry foam cushions with modular back pillows","Design: L-shape modular sofa set (6-seater) with central coffee table"],"imgIdx":3,"matrix":{"dims":"Modular L-shape layout","wt":"95 kg (total set)","lt":"40-50 days","maint":"Minimal","life":"12+ years","custom":"Modular link buckles & quick-dry mesh bases"}}, badge: "Smart Ready" }
    ];
        ...
        <div ref={pageContainerRef} className="w-full bg-[#F7F4EF] text-[#1A1A1A] font-sans pb-24 overflow-x-hidden pt-28">
            ...
            <div className="max-w-[1280px] mx-auto px-6 md:px-12 py-4 select-none">
                <nav className="flex items-center text-[10px] sm:text-xs font-bold uppercase tracking-widest text-[#2C5F2E] gap-2">
                    ...
                    <span>/</span>
                    <span className="text-[#C9A84C]">Wicker Furniture</span>
                </nav>
            </div>
                    ...
                    <div className="flex flex-col justify-center space-y-8 py-20 lg:py-24 text-left">
                        ...
                        <div className="flex flex-wrap items-center gap-x-6 gap-y-3 pt-4 border-t border-[#DCDAD5]">
                            ...
                            <div className="flex items-center space-x-2 text-[#44474A]">
                                ...
                                <span className="font-label-technical text-[12px]">45+ Projects Delivered</span>
                            </div>
                        </div>
                        ...
                        <div className="relative h-full lg:h-[97%] w-full">
                            ...
                            <div className="relative h-full min-h-[600px] w-full overflow-hidden border border-[#DCDAD5] bg-[#E8E6E0] rounded-none">
                                {carouselImages.map((img, idx) => (
                                    <img
                                        key={idx}
                                        alt={"Premium Wicker Furniture " + (idx + 1)}
            ...
            <section className="bg-[#F7F4EF] py-24 px-6 md:px-12 border-b border-[#C9A84C] transition-all duration-1000 opacity-100 translate-y-0">
                <div className="max-w-[1280px] mx-auto text-left">
                    <div className="mb-16 text-left space-y-4">
                        <h2 className="font-headline-lg text-[32px] text-[#1A1A1A] text-left">Why Quality Wicker Furniture Matter in Public & Outdoor Spaces</h2>
            ...
            <section className="bg-[#F7F4EF] py-24 px-6 md:px-12 border-b border-[#C9A84C] transition-all duration-1000 opacity-100 translate-y-0">
                <div className="max-w-[1280px] mx-auto">
                    <div className="mb-16 space-y-4 text-left">
                        <h2 className="font-headline-lg text-[32px] text-[#1A1A1A] text-left">Three Wicker Furniture Configurations — Choose What Fits Your Project</h2>
                        <div className="w-24 h-1 bg-[#C9A84C]"></div>
                        <p className="font-body-lg text-[18px] text-[#44474A] max-w-3xl">
                        ...
                        {configCards.map((card, idx) => (
                            <div key={card.key} className="bg-[#F2F0EB] border border-[#DCDAD5] rounded-none transition-all group p-0 flex flex-col justify-between overflow-hidden text-left">
                                ...
                                <div className="p-8 pt-0">
                                    <Link to={"/get-quote/?product=wicker-furniture&variant=" + card.key} className="bg-[#2C5F2E] text-white px-6 py-3 font-label-technical uppercase tracking-widest text-xs inline-block text-center rounded-[4px] border-b-2 border-[#1A1A1A] hover:bg-[#C9A84C] hover:text-[#1A1C1E] transition-colors w-full">
            ...
            <section className="bg-[#F7F4EF] py-24 px-6 md:px-12 border-b border-[#C9A84C] transition-all duration-1000 opacity-100 translate-y-0">
                <div className="max-w-[1280px] mx-auto">
                    <div className="mb-16 space-y-4 text-left">
                        ...
                        <p className="font-label-technical text-[#2C5F2E] uppercase tracking-widest font-bold">45+ major projects delivered | 12+ cities served</p>
                    </div>
                    ...
                    <div className="bg-[#2C5F2E] text-white p-6 md:p-10 mb-20 flex flex-col md:flex-row gap-6 md:gap-10 items-center rounded-none">
                        <div className="md:w-1/2 space-y-6 text-left">
                            ...
                            <h3 className="font-headline-md text-[24px] text-white leading-tight text-left">Premium Wicker Dining Set — Resort Collection</h3>
                            <p className="font-body-lg opacity-90 leading-relaxed">
                                Hotel rooftop dining, open-air resort restaurants, large villa terraces. Featuring Frame: Structural anodized aluminium under-chassis, Body Wrap: High-grade HDPE wicker flat weave, Cushions: 50mm quick-dry foam seat pads with Sunbrella covers, Design: 6x Dining armchairs, 1x Rectangular dining table (tempered glass top).
                            </p>
                        </div>
            ...
            {/* FINAL CTA SECTION */}
            <CTASection 
                title="Ready to Specify Wicker Furniture for Your Project?"
                primaryLink="/get-quote/?product=wicker-furniture"
            />
        </div>
    );
};
