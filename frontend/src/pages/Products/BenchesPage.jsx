...
const BenchesPage = () => {
    ...
    return (
        <div className="w-full bg-surface text-on-surface font-body-md antialiased overflow-x-hidden min-h-screen flex flex-col">
            ...
            <section className="reveal-section bg-surface-container-low py-24 px-margin-mobile md:px-margin-desktop border-b border-outline-variant">
                <div className="max-w-container-max mx-auto">
                    <div className="mb-16 text-left space-y-4">
                        <span className="font-label-technical text-craftsman-gold tracking-[0.2em] uppercase font-semibold text-xs block">
                            Technical Specifications
                        </span>
                        <h2 className="font-headline-lg text-headline-lg text-deep-ink">Materials & Customization Guide</h2>
                        <div className="w-24 h-1 bg-craftsman-gold"></div>
                        <p className="font-body-lg text-body-lg text-on-surface-variant max-w-3xl">
                            Compare our high-performance materials and explore how we can tailor our benches to your specific project requirements.
                        </p>
                    </div>

                    {/* Material Comparison Table */}
                    <div className="mb-20 overflow-x-auto border border-outline-variant">
                        <table className="w-full border-collapse bg-surface-container-lowest">
                            <thead>
                                <tr className="bg-primary text-on-primary font-label-technical uppercase tracking-widest text-xs md:text-sm">
                                    <th className="p-4 md:p-6 text-left font-semibold">Material</th>
                                    <th className="p-4 md:p-6 text-left font-semibold">Lifespan</th>
                                    <th className="p-4 md:p-6 text-left font-semibold">Maintenance</th>
                                    <th className="p-4 md:p-6 text-left font-semibold">Best For</th>
                                </tr>
                            </thead>
                            <tbody className="text-sm md:text-body-md text-on-surface">
                                <tr className="border-b border-outline-variant hover:bg-surface-container-low/50 transition-colors">
                                    <td className="p-4 md:p-6 font-bold">WPC</td>
                                    <td className="p-4 md:p-6">
                                        <div className="flex items-center gap-2">
                                            <span className="min-w-20">12-15 yrs</span>
                                            <div className="h-2 w-24 bg-secondary/20 rounded-full overflow-hidden">
                                                <div className="h-full bg-secondary w-[60%]"></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="p-4 md:p-6">Very low</td>
                                    <td className="p-4 md:p-6 font-medium">Gardens/Premium areas</td>
                                </tr>
                                <tr className="border-b border-outline-variant hover:bg-surface-container-low/50 transition-colors">
                                    <td className="p-4 md:p-6 font-bold">NFC Wood</td>
                                    <td className="p-4 md:p-6">
                                        <div className="flex items-center gap-2">
                                            <span className="min-w-20">15-20+ yrs</span>
                                            <div className="h-2 w-24 bg-secondary/20 rounded-full overflow-hidden">
                                    ...
                                    <td className="p-4 md:p-6">Very low</td>
                                    <td className="p-4 md:p-6 font-medium">Architectural/Modern</td>
                                </tr>
                                <tr className="border-b border-outline-variant hover:bg-surface-container-low/50 transition-colors">
                                    <td className="p-4 md:p-6 font-bold">Aluminium</td>
                                    <td className="p-4 md:p-6">
                                        <div className="flex items-center gap-2">
                                            <span className="min-w-20">15-20+ yrs</span>
                                            <div className="h-2 w-24 bg-secondary/20 rounded-full overflow-hidden">
                                    ...
                                    <td className="p-4 md:p-6">Minimal</td>
                                    <td className="p-4 md:p-6 font-medium">Coastal/Modern</td>
                                </tr>
                                <tr className="border-b border-outline-variant hover:bg-surface-container-low/50 transition-colors">
                                    <td className="p-4 md:p-6 font-bold">Mild Steel</td>
                                    <td className="p-4 md:p-6">
                                        <div className="flex items-center gap-2">
                                            <span className="min-w-20">8-12 yrs</span>
                                            <div className="h-2 w-24 bg-secondary/20 rounded-full overflow-hidden">
                                                <div className="h-full bg-secondary w-[40%]"></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="p-4 md:p-6">Low</td>
                                    <td className="p-4 md:p-6 font-medium">Parks/General</td>
                                </tr>
                                <tr className="hover:bg-surface-container-low/50 transition-colors">
                                    <td className="p-4 md:p-6 font-bold">Stainless Steel</td>
                                    <td className="p-4 md:p-6">
                                        <div className="flex items-center gap-2">
                                            <span className="min-w-20">15-20+ yrs</span>
                                            <div className="h-2 w-24 bg-secondary/20 rounded-full overflow-hidden">
                                    ...
                                    <td className="p-4 md:p-6">Very low</td>
                                    <td className="p-4 md:p-6 font-medium">High-end/Coastal</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
                        <div className="p-6 bg-surface-container-lowest border border-outline-variant text-center space-y-3 hover:border-primary transition-colors">
                            <span className="material-symbols-outlined text-primary text-3xl">straighten</span>
                            <h4 className="font-bold text-on-surface text-sm uppercase tracking-wider font-label-technical">Length</h4>
                            <p className="text-xs text-on-surface-variant">1.2m to custom sizes</p>
                        </div>
                        <div className="p-6 bg-surface-container-lowest border border-outline-variant text-center space-y-3 hover:border-primary transition-colors">
                            <span className="material-symbols-outlined text-primary text-3xl">chair</span>
                            <h4 className="font-bold text-on-surface text-sm uppercase tracking-wider font-label-technical">Design</h4>
                            <p className="text-xs text-on-surface-variant">Backrest & Armrests</p>
                        </div>
                        <div className="p-6 bg-surface-container-lowest border border-outline-variant text-center space-y-3 hover:border-primary transition-colors">
                            <span className="material-symbols-outlined text-primary text-3xl">grid_view</span>
                            <h4 className="font-bold text-on-surface text-sm uppercase tracking-wider font-label-technical">Seating</h4>
                            <p className="text-xs text-on-surface-variant">WPC/NFC/Alu/Perforated</p>
                        </div>
                        <div className="p-6 bg-surface-container-lowest border border-outline-variant text-center space-y-3 hover:border-primary transition-colors">
                            <span className="material-symbols-outlined text-primary text-3xl">format_paint</span>
                            <h4 className="font-bold text-on-surface text-sm uppercase tracking-wider font-label-technical">Finish</h4>
                            <p className="text-xs text-on-surface-variant">Powder/Brushed/Natural</p>
                        </div>
                        <div className="p-6 bg-surface-container-lowest border border-outline-variant text-center space-y-3 hover:border-primary transition-colors">
