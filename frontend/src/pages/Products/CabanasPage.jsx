    ...
    const trackEvent = (eventName, value = "") => {
        if (window.gtag) {
            window.gtag("event", eventName, {
                ...
                event_label: "cabanaspage",
                value: value
            });
        }
        console.log(`[GA4 Event] ${eventName} | Category: product_page | Label: cabanaspage | Value: ${value}`);
    };
    ...
    const renderStandardTab = () => (
        <div className="animate-fadeIn">
            <div className="mb-6">
                ...
                <h3 className="text-xl sm:text-2xl md:text-3xl font-black uppercase text-[#1A1A1A] mt-3">Standard Single Cabana — Sleek & Intimate</h3>
                <h4 className="text-xs sm:text-sm font-semibold uppercase tracking-wider text-[#2D2D2D]/60 mt-1">Best for: Boutique hotel pool decks, private villa gardens, luxury apartment terraces.</h4>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 border-t border-[#2D2D2D]/10 pt-8">
                <div>
                    ...
                    <ul className="flex flex-col gap-3 text-xs sm:text-sm font-semibold text-[#1A1A1A]/85">
                        {["Frame: Mild Steel with heavy powder coating","Upholstery: Water-resistant polyester curtains","Bed cushion: 100mm high-density foam","Capacity: 1-2 persons"].map((f, idx) => (
                    ...
                    <p className="text-xs sm:text-sm text-[#2D2D2D]/75 font-semibold leading-relaxed">
                        Boutique hotel pool decks, private villa gardens, luxury apartment terraces.
                    </p>
                </div>
                        ...
                        <div className="w-full border border-black/[0.04] rounded-2xl bg-white p-4 sm:p-6 overflow-hidden shadow-sm">
                            <div className="grid grid-cols-1 min-[380px]:grid-cols-2 gap-y-4 gap-x-4 text-xs font-semibold text-[#1A1A1A]">
                                <div>
                                    ...
                                    <span className="font-bold">1800L × 1800W × 2100H mm</span>
                                </div>
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Weight</span>
                                    <span className="font-bold">95-110 kg</span>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <span className="font-bold">Low (periodic fabric wash)</span>
                                </div>
                                <div className="col-span-2 border-t border-black/[0.04] pt-3 mt-1">
                                    ...
                                    <span className="font-bold text-[#2C5F2E]">5-7 years</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    const renderPremiumTab = () => (
        <div className="animate-fadeIn">
            <div className="mb-6">
                ...
                <h3 className="text-xl sm:text-2xl md:text-3xl font-black uppercase text-[#1A1A1A] mt-3">Premium Double Cabana — Resort Style</h3>
                <h4 className="text-xs sm:text-sm font-semibold uppercase tracking-wider text-[#2D2D2D]/60 mt-1">Best for: 5-star resort pool decks, oceanfront hotels, premium country clubs.</h4>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 border-t border-[#2D2D2D]/10 pt-8">
                <div>
                    <h4 className="text-[0.8125rem] md:text-sm font-black uppercase tracking-widest text-[#2C5F2E] mb-4 select-none">— Key Features</h4>
                    <ul className="flex flex-col gap-3 text-xs sm:text-sm font-semibold text-[#1A1A1A]/85">
                        {["Frame: Anodized Aluminium with powder coating","Upholstery: Sunbrella outdoor canvas privacy drapes","Bed cushion: 150mm quick-dry foam cushion with mesh bottom","Capacity: 2-3 persons"].map((f, idx) => (
                            <li key={idx} className="flex items-center gap-3"><span className="text-[#C9A84C]">▸</span> {f}</li>
                        ))}
                    </ul>
                    ...
                    <h4 className="text-[0.8125rem] md:text-sm font-black uppercase tracking-widest text-[#2C5F2E] mt-10 mb-4 select-none">— Ideal For</h4>
                    <p className="text-xs sm:text-sm text-[#2D2D2D]/75 font-semibold leading-relaxed">
                        5-star resort pool decks, oceanfront hotels, premium country clubs.
                    </p>
                </div>
                    ...
                    <div>
                        ...
                        <div className="w-full border border-black/[0.04] rounded-2xl bg-white p-4 sm:p-6 overflow-hidden shadow-sm">
                            <div className="grid grid-cols-1 min-[380px]:grid-cols-2 gap-y-4 gap-x-4 text-xs font-semibold text-[#1A1A1A]">
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Dimensions</span>
                                    <span className="font-bold">2000L × 2000W × 2200H mm</span>
                                </div>
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Weight</span>
                                    <span className="font-bold">120-140 kg</span>
                                </div>
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Lead Time</span>
                                    <span className="font-bold">35-40 days</span>
                                </div>
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Annual Maintenance</span>
                                    <span className="font-bold">Wash fabrics seasonal</span>
                                </div>
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Lifespan</span>
                                ...
                                <div>
                                    ...
                                    <span className="font-bold text-[#2C5F2E]">Concealed deck mounting brackets</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    const renderSuperPremiumTab = () => (
        <div className="animate-fadeIn">
            <div className="mb-6">
                ...
                <h3 className="text-xl sm:text-2xl md:text-3xl font-black uppercase text-[#1A1A1A] mt-3">Super Premium Daybed Pavilion — Smart Integrated</h3>
                <h4 className="text-xs sm:text-sm font-semibold uppercase tracking-wider text-[#2D2D2D]/60 mt-1">Best for: Mega resorts, high-end beach clubs, private luxury estate lawns.</h4>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 border-t border-[#2D2D2D]/10 pt-8">
                <div>
                    <h4 className="text-[0.8125rem] md:text-sm font-black uppercase tracking-widest text-[#2C5F2E] mb-4 select-none">— Key Features</h4>
                    <ul className="flex flex-col gap-3 text-xs sm:text-sm font-semibold text-[#1A1A1A]/85">
                        {["Frame: Marine-grade Stainless Steel 316 wrapped in synthetic PE wicker","Upholstery: Sunbrella performance fabrics with automated tracks","Bed cushion: 150mm memory quick-dry foam bed with backrests","Tech: Integrated solar panels, LED interior lighting, dual USB ports, side beverage fridge"].map((f, idx) => (
                            <li key={idx} className="flex items-center gap-3"><span className="text-[#C9A84C]">▸</span> {f}</li>
                        ))}
                    </ul>
                    ...
                    <h4 className="text-[0.8125rem] md:text-sm font-black uppercase tracking-widest text-[#2C5F2E] mt-10 mb-4 select-none">— Ideal For</h4>
                    <p className="text-xs sm:text-sm text-[#2D2D2D]/75 font-semibold leading-relaxed">
                        Mega resorts, high-end beach clubs, private luxury estate lawns.
                    </p>
                </div>
                    ...
                    <div>
                        ...
                        <div className="w-full border border-black/[0.04] rounded-2xl bg-white p-4 sm:p-6 overflow-hidden shadow-sm">
                            <div className="grid grid-cols-1 min-[380px]:grid-cols-2 gap-y-4 gap-x-4 text-xs font-semibold text-[#1A1A1A]">
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Dimensions</span>
                                    <span className="font-bold">2400L × 2400W × 2400H mm</span>
                                </div>
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Weight</span>
                                    <span className="font-bold">220-250 kg</span>
                                </div>
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Lead Time</span>
                                ...
                                <div>
                                    ...
                                    <span className="font-bold text-[#2C5F2E]">Smart automation & solar integration</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div ref={pageContainerRef} className="w-full bg-[#F7F4EF] text-[#1A1A1A] font-sans pb-24 overflow-x-hidden pt-28">
            ...
            <div className={`fixed top-0 left-0 w-full bg-white/95 backdrop-blur-md border-b border-[#2D2D2D]/10 py-4 px-8 lg:px-16 z-[99] flex justify-between items-center transition-all duration-500 shadow-md ${showStickyHeader ? "translate-y-0 opacity-100" : "-translate-y-full opacity-0 pointer-events-none"}`}>
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-[10px] uppercase font-bold tracking-widest text-[#2D2D2D]/50 hidden sm:inline">Cabanas</span>
                </div>
                <Link
                    to="/get-quote/?product=cabanas"
            ...
            <div className="max-w-[1400px] 3xl:max-w-[1700px] 4xl:max-w-[2200px] 5xl:max-w-[3000px] mx-auto px-6 md:px-12 py-4 select-none">
                <nav className="flex items-center text-[10px] sm:text-xs font-bold uppercase tracking-widest text-[#2D2D2D]/60 gap-2">
                    ...
                    <span>/</span>
                    <span className="text-[#2C5F2E]">Cabanas</span>
                </nav>
            </div>
            ...
            <section className="max-w-[1400px] 3xl:max-w-[1700px] 4xl:max-w-[2200px] 5xl:max-w-[3000px] mx-auto px-6 md:px-12 mb-24">
                <div className="text-left mb-12 max-w-4xl">
                    ...
                    <h2 className="text-3xl sm:text-5xl font-black uppercase tracking-tight leading-none text-[#1A1A1A]">
                        Three Cabanas Configurations — Choose What Fits Your Project
                    </h2>
                        ...
                        <table className="w-full text-left border-collapse min-w-[650px]">
                            ...
                            <tbody className="text-xs font-semibold text-[#1A1A1A]/85">
                                ...
                                <tr className="border-b border-[#2D2D2D]/10 hover:bg-[#F7F4EF]/45">
                                    ...
                                    <td className="p-5">35-40 days</td>
            ...
            <section className="max-w-[1400px] 3xl:max-w-[1700px] 4xl:max-w-[2200px] 5xl:max-w-[3000px] mx-auto px-6 md:px-12 mb-24">
                ...
                <div className="bg-[#2D2D2D] rounded-[2rem] border border-white/5 p-8 md:p-10 text-white flex flex-col md:flex-row justify-between items-center text-center gap-8 shadow-md">
                    <div className="flex-1">
                        <span className="block text-3xl font-black uppercase tracking-tight text-[#C9A84C]">30+</span>
                        <span className="text-[9px] sm:text-[10px] uppercase font-bold tracking-widest text-white/55 mt-1 block">Luxury Hospitality Projects</span>
                    </div>
                    ...
                    <div className="w-[1px] h-8 bg-white/10 md:block hidden" />
                    <div className="flex-1">
                        <span className="block text-3xl font-black uppercase tracking-tight text-[#C9A84C]">500+</span>
                        <span className="text-[9px] sm:text-[10px] uppercase font-bold tracking-widest text-white/55 mt-1 block">Luxury Cabanas Delivered</span>
                    </div>
                </div>
            </section>
