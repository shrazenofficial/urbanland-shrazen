...
const SSBollardsPage = () => {
    ...
    const configCards = [
        { key: "standard", data: {"title":"Standard Fixed Bollard — Surface Anchored","ideal":"Pedestrian walkway boundaries, retail shopfronts, residential park paths.","features":["Material: Stainless Steel 304 tube","Finish: Satin brushed steel finish","Design: Flat top fixed surface mounted bollard","Capacity: Standard pedestrian boundary barrier"],"imgIdx":1,"matrix":{"dims":"800H × 114D mm (3mm wall)","wt":"12-15 kg","lt":"15-20 days","maint":"Zero (periodic wipe)","life":"10-12 years","custom":"Surface mount anchor flange"}}, badge: "Value Option" },
        { key: "premium", data: {"title":"Premium Fixed Bollard — Inground Cast Core","ideal":"Airport terminals, corporate park entrance gates, shopping mall driveways.","features":["Material: Stainless Steel 316 (coastal marine grade)","Finish: Mirror polished steel with reflective hazard band","Design: Domed top inground bollard for concrete casting","Capacity: Medium-impact security core barrier"],"imgIdx":2,"matrix":{"dims":"1000H × 168D mm (4mm wall)","wt":"25-30 kg (empty)","lt":"20-25 days","maint":"Zero","life":"15+ years","custom":"Extended sub-surface casting root"}}, badge: "Most Specified" },
        { key: "super", data: {"title":"Super Premium Bollard — Removable Key-Lockable","ideal":"Emergency vehicle lanes, VIP parking zones, municipal plazas.","features":["Material: Heavy-wall SS 316 tube with cast steel ground sleeve","Finish: Satin brushed steel with integrated LED light head","Design: Removable lockable bollard with internal locking brass lock","Tech: Low-voltage LED illuminated head ring"],"imgIdx":3,"matrix":{"dims":"900H × 140D mm (5mm wall)","wt":"35 kg (bollard) + 12 kg (sleeve)","lt":"25-35 days","maint":"Annual lock cylinder lube","life":"20+ years","custom":"Sleeve flush ground cover lid"}}, badge: "Smart Ready" }
    ];
        ...
        <div ref={pageContainerRef} className="w-full bg-[#F7F4EF] text-[#1A1A1A] font-sans pb-24 overflow-x-hidden pt-28">
            ...
            <div className="max-w-[1280px] mx-auto px-6 md:px-12 py-4 select-none">
                <nav className="flex items-center text-[10px] sm:text-xs font-bold uppercase tracking-widest text-[#2C5F2E] gap-2">
                    ...
                    <span>/</span>
                    <span className="text-[#C9A84C]">SS Bollards</span>
                </nav>
            </div>
                    ...
                    <div className="flex flex-col justify-center space-y-8 py-20 lg:py-24 text-left">
                        ...
                        <div className="flex flex-wrap items-center gap-x-6 gap-y-3 pt-4 border-t border-[#DCDAD5]">
                            ...
                            <div className="flex items-center space-x-2 text-[#44474A]">
                                ...
                                <span className="font-label-technical text-[12px]">70+ Projects Delivered</span>
                            </div>
                        </div>
            ...
            <section className="bg-[#F7F4EF] py-24 px-6 md:px-12 border-b border-[#C9A84C] transition-all duration-1000 opacity-100 translate-y-0">
                <div className="max-w-[1280px] mx-auto text-left">
                    <div className="mb-16 text-left space-y-4">
                        <h2 className="font-headline-lg text-[32px] text-[#1A1A1A] text-left">Why Quality SS Bollards Matter in Public & Outdoor Spaces</h2>
            ...
            <section className="bg-[#F7F4EF] py-24 px-6 md:px-12 border-b border-[#C9A84C] transition-all duration-1000 opacity-100 translate-y-0">
                <div className="max-w-[1280px] mx-auto">
                    <div className="mb-16 space-y-4 text-left">
                        <h2 className="font-headline-lg text-[32px] text-[#1A1A1A] text-left">Three SS Bollards Configurations — Choose What Fits Your Project</h2>
                        <div className="w-24 h-1 bg-[#C9A84C]"></div>
                        <p className="font-body-lg text-[18px] text-[#44474A] max-w-3xl">
                        ...
                        {configCards.map((card, idx) => (
                            <div key={card.key} className="bg-[#F2F0EB] border border-[#DCDAD5] rounded-none transition-all group p-0 flex flex-col justify-between overflow-hidden text-left">
                                ...
                                <div className="p-8 pt-0">
                                    <Link to={"/get-quote/?product=ss-bollards&variant=" + card.key} className="bg-[#2C5F2E] text-white px-6 py-3 font-label-technical uppercase tracking-widest text-xs inline-block text-center rounded-[4px] border-b-2 border-[#1A1A1A] hover:bg-[#C9A84C] hover:text-[#1A1C1E] transition-colors w-full">
            ...
            <section className="bg-[#F7F4EF] py-24 px-6 md:px-12 border-b border-[#C9A84C] transition-all duration-1000 opacity-100 translate-y-0">
                <div className="max-w-[1280px] mx-auto">
                    <div className="mb-16 space-y-4 text-left">
                        ...
                        <p className="font-label-technical text-[#2C5F2E] uppercase tracking-widest font-bold">70+ major projects delivered | 22+ cities served</p>
                    </div>
                    ...
                    <div className="bg-[#2C5F2E] text-white p-6 md:p-10 mb-20 flex flex-col md:flex-row gap-6 md:gap-10 items-center rounded-none">
                        <div className="md:w-1/2 space-y-6 text-left">
                            ...
                            <h3 className="font-headline-md text-[24px] text-white leading-tight text-left">Premium Fixed Bollard — Inground Cast Core</h3>
                            <p className="font-body-lg opacity-90 leading-relaxed">
                                Airport terminals, corporate park entrance gates, shopping mall driveways. Featuring Material: Stainless Steel 316 (coastal marine grade), Finish: Mirror polished steel with reflective hazard band, Design: Domed top inground bollard for concrete casting, Capacity: Medium-impact security core barrier.
                            </p>
                        </div>
