    ...
    const trackEvent = (eventName, value = "") => {
        if (window.gtag) {
            window.gtag("event", eventName, {
                ...
                event_label: "ssbollardspage",
                value: value
            });
        }
        console.log(`[GA4 Event] ${eventName} | Category: product_page | Label: ssbollardspage | Value: ${value}`);
    };
    ...
    const renderStandardTab = () => (
        <div className="animate-fadeIn">
            <div className="mb-6">
                ...
                <h3 className="text-xl sm:text-2xl md:text-3xl font-black uppercase text-[#1A1A1A] mt-3">Standard Fixed Bollard — Surface Anchored</h3>
                <h4 className="text-xs sm:text-sm font-semibold uppercase tracking-wider text-[#2D2D2D]/60 mt-1">Best for: Pedestrian walkway boundaries, retail shopfronts, residential park paths.</h4>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 border-t border-[#2D2D2D]/10 pt-8">
                <div>
                    ...
                    <ul className="flex flex-col gap-3 text-xs sm:text-sm font-semibold text-[#1A1A1A]/85">
                        {["Material: Stainless Steel 304 tube","Finish: Satin brushed steel finish","Design: Flat top fixed surface mounted bollard","Capacity: Standard pedestrian boundary barrier"].map((f, idx) => (
                    ...
                    <p className="text-xs sm:text-sm text-[#2D2D2D]/75 font-semibold leading-relaxed">
                        Pedestrian walkway boundaries, retail shopfronts, residential park paths.
                    </p>
                </div>
                        ...
                        <div className="w-full border border-black/[0.04] rounded-2xl bg-white p-4 sm:p-6 overflow-hidden shadow-sm">
                            <div className="grid grid-cols-1 min-[380px]:grid-cols-2 gap-y-4 gap-x-4 text-xs font-semibold text-[#1A1A1A]">
                                <div>
                                    ...
                                    <span className="font-bold">800H × 114D mm (3mm wall)</span>
                                </div>
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Weight</span>
                                    <span className="font-bold">12-15 kg</span>
                                </div>
                                <div>
    ...
    const renderPremiumTab = () => (
        <div className="animate-fadeIn">
            <div className="mb-6">
                ...
                <h3 className="text-xl sm:text-2xl md:text-3xl font-black uppercase text-[#1A1A1A] mt-3">Premium Fixed Bollard — Inground Cast Core</h3>
                <h4 className="text-xs sm:text-sm font-semibold uppercase tracking-wider text-[#2D2D2D]/60 mt-1">Best for: Airport terminals, corporate park entrance gates, shopping mall driveways.</h4>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 border-t border-[#2D2D2D]/10 pt-8">
                <div>
                    <h4 className="text-[0.8125rem] md:text-sm font-black uppercase tracking-widest text-[#2C5F2E] mb-4 select-none">— Key Features</h4>
                    <ul className="flex flex-col gap-3 text-xs sm:text-sm font-semibold text-[#1A1A1A]/85">
                        {["Material: Stainless Steel 316 (coastal marine grade)","Finish: Mirror polished steel with reflective hazard band","Design: Domed top inground bollard for concrete casting","Capacity: Medium-impact security core barrier"].map((f, idx) => (
                            <li key={idx} className="flex items-center gap-3"><span className="text-[#C9A84C]">▸</span> {f}</li>
                        ))}
                    </ul>
                    ...
                    <h4 className="text-[0.8125rem] md:text-sm font-black uppercase tracking-widest text-[#2C5F2E] mt-10 mb-4 select-none">— Ideal For</h4>
                    <p className="text-xs sm:text-sm text-[#2D2D2D]/75 font-semibold leading-relaxed">
                        Airport terminals, corporate park entrance gates, shopping mall driveways.
                    </p>
                </div>
                    ...
                    <div>
                        ...
                        <div className="w-full border border-black/[0.04] rounded-2xl bg-white p-4 sm:p-6 overflow-hidden shadow-sm">
                            <div className="grid grid-cols-1 min-[380px]:grid-cols-2 gap-y-4 gap-x-4 text-xs font-semibold text-[#1A1A1A]">
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Dimensions</span>
                                    <span className="font-bold">1000H × 168D mm (4mm wall)</span>
                                </div>
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Weight</span>
                                    <span className="font-bold">25-30 kg (empty)</span>
                                </div>
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Lead Time</span>
                                ...
                                <div>
                                    ...
                                    <span className="font-bold text-[#2C5F2E]">Extended sub-surface casting root</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    const renderSuperPremiumTab = () => (
        <div className="animate-fadeIn">
            <div className="mb-6">
                ...
                <h3 className="text-xl sm:text-2xl md:text-3xl font-black uppercase text-[#1A1A1A] mt-3">Super Premium Bollard — Removable Key-Lockable</h3>
                <h4 className="text-xs sm:text-sm font-semibold uppercase tracking-wider text-[#2D2D2D]/60 mt-1">Best for: Emergency vehicle lanes, VIP parking zones, municipal plazas.</h4>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 border-t border-[#2D2D2D]/10 pt-8">
                <div>
                    <h4 className="text-[0.8125rem] md:text-sm font-black uppercase tracking-widest text-[#2C5F2E] mb-4 select-none">— Key Features</h4>
                    <ul className="flex flex-col gap-3 text-xs sm:text-sm font-semibold text-[#1A1A1A]/85">
                        {["Material: Heavy-wall SS 316 tube with cast steel ground sleeve","Finish: Satin brushed steel with integrated LED light head","Design: Removable lockable bollard with internal locking brass lock","Tech: Low-voltage LED illuminated head ring"].map((f, idx) => (
                            <li key={idx} className="flex items-center gap-3"><span className="text-[#C9A84C]">▸</span> {f}</li>
                        ))}
                    </ul>
                    ...
                    <h4 className="text-[0.8125rem] md:text-sm font-black uppercase tracking-widest text-[#2C5F2E] mt-10 mb-4 select-none">— Ideal For</h4>
                    <p className="text-xs sm:text-sm text-[#2D2D2D]/75 font-semibold leading-relaxed">
                        Emergency vehicle lanes, VIP parking zones, municipal plazas.
                    </p>
                </div>
                    ...
                    <div>
                        ...
                        <div className="w-full border border-black/[0.04] rounded-2xl bg-white p-4 sm:p-6 overflow-hidden shadow-sm">
                            <div className="grid grid-cols-1 min-[380px]:grid-cols-2 gap-y-4 gap-x-4 text-xs font-semibold text-[#1A1A1A]">
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Dimensions</span>
                                    <span className="font-bold">900H × 140D mm (5mm wall)</span>
                                </div>
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Weight</span>
                                    <span className="font-bold">35 kg (bollard) + 12 kg (sleeve)</span>
                                </div>
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Lead Time</span>
                                ...
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Annual Maintenance</span>
                                    <span className="font-bold">Annual lock cylinder lube</span>
                                </div>
                                <div>
                                    <span className="block text-[8px] uppercase tracking-wider text-black/45 mb-0.5">Lifespan</span>
                                ...
                                <div>
                                    ...
                                    <span className="font-bold text-[#2C5F2E]">Sleeve flush ground cover lid</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div ref={pageContainerRef} className="w-full bg-[#F7F4EF] text-[#1A1A1A] font-sans pb-24 overflow-x-hidden pt-28">
            ...
            <div className={`fixed top-0 left-0 w-full bg-white/95 backdrop-blur-md border-b border-[#2D2D2D]/10 py-4 px-8 lg:px-16 z-[99] flex justify-between items-center transition-all duration-500 shadow-md ${showStickyHeader ? "translate-y-0 opacity-100" : "-translate-y-full opacity-0 pointer-events-none"}`}>
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-[10px] uppercase font-bold tracking-widest text-[#2D2D2D]/50 hidden sm:inline">SS Bollards</span>
                </div>
                <Link
                    to="/get-quote/?product=ss-bollards"
            ...
            <div className="max-w-[1400px] 3xl:max-w-[1700px] 4xl:max-w-[2200px] 5xl:max-w-[3000px] mx-auto px-6 md:px-12 py-4 select-none">
                <nav className="flex items-center text-[10px] sm:text-xs font-bold uppercase tracking-widest text-[#2D2D2D]/60 gap-2">
                    ...
                    <span>/</span>
                    <span className="text-[#2C5F2E]">SS Bollards</span>
                </nav>
            </div>
            ...
            <section className="max-w-[1400px] 3xl:max-w-[1700px] 4xl:max-w-[2200px] 5xl:max-w-[3000px] mx-auto px-6 md:px-12 mb-24">
                <div className="text-left mb-16 max-w-5xl">
                    ...
                    <p className="text-sm sm:text-base md:text-lg text-[#2D2D2D]/75 leading-relaxed mt-6">
                        Why People Choose Urbanland SS Bollards
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 select-none">
                    {[{"title":"Premium Steel Grades","desc":"Manufactured in high-yield Stainless Steel 304 or marine-grade 316, ensuring zero rust in coastal or high-pollution cities."},{"title":"Impact Core Ready","desc":"Internal structural cores can be filled with concrete and rebar to function as heavy-duty anti-ram vehicle barriers."},{"title":"Removable Options","desc":"Removable variants feature key-lockable sub-surface sleeves, allowing security teams to easily control vehicle access."},{"title":"ISO Certified QC","desc":"All bollards undergo strict dimensional checks and ultrasonic weld tests to guarantee high structural integrity."}].map((r, idx) => (
            ...
            <section className="max-w-[1400px] 3xl:max-w-[1700px] 4xl:max-w-[2200px] 5xl:max-w-[3000px] mx-auto px-6 md:px-12 mb-24">
                <div className="text-left mb-12 max-w-4xl">
                    ...
                    <h2 className="text-3xl sm:text-5xl font-black uppercase tracking-tight leading-none text-[#1A1A1A]">
                        Three SS Bollards Configurations — Choose What Fits Your Project
                    </h2>
            ...
            <section id="specifications" className="max-w-[1400px] 3xl:max-w-[1700px] 4xl:max-w-[2200px] 5xl:max-w-[3000px] mx-auto px-6 md:px-12 mb-24">
                ...
                <div className="w-full overflow-x-auto border border-black/[0.04] rounded-3xl bg-white shadow-sm mb-12 scrollbar-thin">
                    <table className="w-full text-left border-collapse min-w-[650px]">
                        ...
                        <tbody className="text-xs font-semibold text-[#1A1A1A]/85">
                            {[{"name":"Stainless Steel 316","life":"20+ years","maint":"Zero maintenance","best":"Coastal & high-humidity beachfronts","cost":"Premium (1.4x vs SS 304)"},{"name":"Stainless Steel 304","life":"12-15 years","maint":"Periodic wipe","best":"Inland urban smart cities & offices","cost":"Base premium price (1x)"},{"name":"Mild Steel Powder-Coated","life":"6-8 years","maint":"Annual paint check","best":"Low budget warehouse perimeters","cost":"Economical (0.5x)"}].map((m, idx) => (
                ...
                <div className="bg-white rounded-[2.5rem] border border-black/[0.03] p-8 md:p-12 mb-12 shadow-sm">
                    <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs sm:text-sm font-bold text-[#1A1A1A]/85">
                        {["Diameters: Standard tubes in 76mm, 114mm, 140mm, 168mm, or 219mm","Heights: Customizable heights above ground from 600mm to 1200mm","Head Styles: Flat top, domed top, semi-domed, chamfered edge, or illuminated LED ring","Reflective bands: High-visibility yellow, white, or red hazard tape grooves","Bollard Types: Permanent fixed, removable key-locked, manual collapsible, or sub-surface cast-in roots"].map((c, idx) => (
            ...
            <section className="max-w-[1400px] 3xl:max-w-[1700px] 4xl:max-w-[2200px] 5xl:max-w-[3000px] mx-auto px-6 md:px-12 mb-24">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 select-none mb-12">
                    {[{"tag":"Nagpur Smart City","subtitle":"Nagpur Municipal Corp","title":"Metro Station Entrances — 300 Fixed SS Bollards","time":"4 months","desc":" Nagpur Smart City authority deployed 300 inground fixed SS 304 bollards across 10 metro station plazas. The concrete-filled bollards provide high-security pedestrian boundary protection."},{"tag":"Taj Lands End","subtitle":"Taj Hotels — Mumbai","title":"Luxury Hotel Driveway Security — 45 SS Bollards","time":"2 months","desc":"Installed custom mirror-polished SS 316 fixed bollards along the hotel entrance driveway. The marine-grade steel resists beachfront salt spray."},{"tag":"Tata Green Hills","subtitle":"Tata Realty — Pune","title":"Emergency Fire Lane Gates — 20 Removable Bollards","time":"2 months","desc":"Supplied and installed 20 removable key-locked bollards at emergency fire exits. The sleeve design allows security staff to clear the road rapidly."}].map((p, idx) => (
                ...
                <div className="bg-[#2D2D2D] rounded-[2rem] border border-white/5 p-8 md:p-10 text-white flex flex-col md:flex-row justify-between items-center text-center gap-8 shadow-md">
                    <div className="flex-1">
                        <span className="block text-3xl font-black uppercase tracking-tight text-[#C9A84C]">70+</span>
                        <span className="text-[9px] sm:text-[10px] uppercase font-bold tracking-widest text-white/55 mt-1 block">Security Projects Completed</span>
                    </div>
                    <div className="w-[1px] h-8 bg-white/10 md:block hidden" />
                    <div className="flex-1">
                        <span className="block text-3xl font-black uppercase tracking-tight text-[#C9A84C]">22+</span>
                        <span className="text-[9px] sm:text-[10px] uppercase font-bold tracking-widest text-white/55 mt-1 block">Cities Served</span>
                    </div>
                    <div className="w-[1px] h-8 bg-white/10 md:block hidden" />
                    <div className="flex-1">
                        <span className="block text-3xl font-black uppercase tracking-tight text-[#C9A84C]">4000+</span>
                        <span className="text-[9px] sm:text-[10px] uppercase font-bold tracking-widest text-white/55 mt-1 block">SS Bollards Delivered</span>
                    </div>
                </div>
            </section>
            ...
            <section className="max-w-[1400px] 3xl:max-w-[1700px] 4xl:max-w-[2200px] 5xl:max-w-[3000px] mx-auto px-6 md:px-12 mb-24">
                ...
                <div className="flex flex-col gap-4 max-w-4xl mx-auto">
                    {[{"q":"What steel grades are available?","a":"We manufacture bollards in Stainless Steel 304 and marine-grade 316. 316 is highly recommended for coastal locations."},{"q":"What is the difference between fixed and removable bollards?","a":"Fixed bollards are cast deep into concrete for permanent access prevention. Removable bollards use a lockable base sleeve for temporary access."},{"q":"Are they impact-resistant?","a":"Yes. We build structural core bollards reinforced with concrete cores to provide high-security vehicle barriers."},{"q":"What is the typical lead time?","a":"Standard SS bollards are manufactured in 20-25 days."},{"q":"Do you customize heights?","a":"Yes. We offer customized bollard heights from 600mm to 1200mm above ground level."}].map((faq, idx) => (
                        <div 
                            key={idx} 
            ...
            {/* FINAL CTA SECTION */}
            <CTASection 
                title="Ready to Specify SS Bollards for Your Project?"
                primaryLink="/get-quote/?product=ss-bollards"
            />
        </div>
    );
};
